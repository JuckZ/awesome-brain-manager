...
<main>
    <h1>
        <Markdown markdown={reminder.title} sourcePath={reminder.file} {component} />
    </h1>
    <span class="reminder-file" on:keydown={onOpenFile} on:click={onOpenFile}>
        <Icon icon="link" />
        {reminder.file}
    </span>
    <div class="reminder-actions">
        ...
        <select class="dropdown later-select" bind:value={selectedIndex} on:change={remindMeLater}>
            <!-- placeholder -->
