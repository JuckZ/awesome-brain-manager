...
export const admonitionPlugin = (md: MarkdownIt, options: Options, containerOptions?: ContainerOptions) => {
...
type ContainerArgs = [typeof container, string, MarkdownItContainer.ContainerOpts];
